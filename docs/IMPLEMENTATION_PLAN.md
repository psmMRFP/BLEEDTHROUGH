...
- [~] 7.6 知识观察、可见研究页与双路线结果已实现；乱序和资源加载自动测试通过，真实玩家／多人／死亡重连验证待进行，见 [Phase 7 技术债记录](PHASE_7_TECH_DEBT.md)；
- [~] 7.7 有界窗口遥测与独立专服脚本已实现，短演练和三小时长测状态见 [Phase 7 技术债记录](PHASE_7_TECH_DEBT.md)；未通过长时间验收。
